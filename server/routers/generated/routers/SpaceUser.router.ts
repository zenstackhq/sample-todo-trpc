    ...
    groupBy: {
        ...
        useQuery: <T extends Prisma.SpaceUserGroupByArgs,
            ...
            , TData = {} extends InputErrors ? Prisma.GetSpaceUserGroupByPayload<T> : InputErrors>(
                ...
                opts?: UseTRPCQueryOptions<string, T, {} extends InputErrors ? Prisma.GetSpaceUserGroupByPayload<T> : InputErrors, TData, Error>
            ) => UseTRPCQueryResult<
                TData,
                TRPCClientErrorLike<AppRouter>
            >;
        ...
        >(
            ...
            opts?: UseTRPCInfiniteQueryOptions<string, T, {} extends InputErrors ? Prisma.GetSpaceUserGroupByPayload<T> : InputErrors, Error>
        ) => UseTRPCInfiniteQueryResult<
