...
export default function createRouter<Config extends BaseConfig>(
    ...
    return router({
        aggregate: procedure
            ...
            .query(({ ctx, input }) => checkRead(db(ctx).user.aggregate(input))),

        createMany: procedure
            .input(UserSchema.createMany)
            .mutation(async ({ ctx, input }) => checkMutate(db(ctx).user.createMany(input))),
        ...
        deleteMany: procedure
            ...
            .mutation(async ({ ctx, input }) => checkMutate(db(ctx).user.deleteMany(input))),
        ...
        findUnique: procedure
            ...
            .query(({ ctx, input }) => checkRead(db(ctx).user.findUnique(input))),

        findUniqueOrThrow: procedure
            .input(UserSchema.findUnique)
            .query(({ ctx, input }) => checkRead(db(ctx).user.findUniqueOrThrow(input))),
        ...
        updateMany: procedure
            ...
            .mutation(async ({ ctx, input }) => checkMutate(db(ctx).user.updateMany(input))),
        ...
        upsert: procedure
            ...
            .mutation(async ({ ctx, input }) => checkMutate(db(ctx).user.upsert(input))),
    });
}
